...
public class Constants
{
    ...
    public static class ItemTags
    {
        ...
        public static final TagKey<Item> SIGN_BLACKLIST = TagKey.create(Registries.ITEM, ResourceLocation.parse("blocks_you_always_wanted:not_allowed_on_signs"));
        public static final TagKey<Item> SIGN_ANVILS = TagKey.create(Registries.ITEM, ResourceLocation.parse("blocks_you_always_wanted:anvil_scaling_on_signs"));
    }
